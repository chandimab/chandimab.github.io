...
?>
        ...
        <div class="col textcolor-white project-block">
			<h5>CO227 Project - ChatBot</h5>
			<p class="textcolor-white"><br>
			This is our second year computer engineering group project. Implementing a ChatBot for the FEeLS (Faculty of Engineering eLearning System).
			</p>
			<p class=""textcolor-white"><a href="https://chandimab.github.io/projects/co227-project-chatbot.html">https://chandimab.github.io/projects/co227-project-chatbot.html</a></p>
		</div>
		
		<div class="col textcolor-white project-block">
			<h5>Simple Auction Server (Java)</h5>
			<p class="textcolor-white"><br>
			Simple Auction Server implementation using Java.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/java-auction-server">https://github.com/chandimab/java-auction-server</a></p>
		</div>
		
		<div class="col textcolor-white project-block">
			<h5>Android - MySQL - PHP Application</h5>
			<p class="textcolor-white"><br>
			This is a sample android application, which can use to scan the barcodes of the products using android smartphone and do purchace using the mobile phone.
			Here i have successfully connected to a MySQL database via PHP scripts to manipulate the database using a android smartphone.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/android-mysql-php">https://github.com/chandimab/android-mysql-php</a></p>
		</div>
      </div>
	  
	  <div class="row">
        <div class="col textcolor-white project-block">
			<h5>Custom CSV File Reader using Java</h5>
			<p class="textcolor-white"><br>
			Simple and custom CSV file reader class for JAVA.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/java/tree/master/csv-file-reader">https://github.com/chandimab/java/tree/master/csv-file-reader</a></p>
		</div>
		
		<div class="col textcolor-white project-block">
			<h5>Motify - Moodle Notification Desktop Application</h5>
			<p class="textcolor-white"><br>
			This is the winning software development of ACES Hackathon 2016. This application basically show notifications of the Faculty Moodle page.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/Motify">https://github.com/chandimab/Motify</a></p>
		</div>
		<div class="col textcolor-white project-block">
			<h5>C - Code Snippets</h5>
			<p class="textcolor-white"><br>
			Useful C Codes.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/c-programming-code-snippets">https://github.com/chandimab/c-programming-code-snippets</a></p>
		</div>
      </div>
	  
	  <div class="row">
        <div class="col textcolor-white project-block">
			<h5>Arduino Codebase</h5>
			<p class="textcolor-white"><br>
			Useful arduino codes.
			</p>
			<p class=""textcolor-white"><a href="https://github.com/chandimab/arduino">https://github.com/chandimab/arduino</a></p>
		</div>
		
		<div class="col textcolor-white project-block">
			<h5></h5>
			<p class="textcolor-white"><br></p>
			<p class=""textcolor-white"><a href=""></a></p>
		</div>
