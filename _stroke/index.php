...
if (empty($url)) {
    if (empty($startURL)) {
      die("<html><head><title>_stroke</title></head><body><h4>_stroke!</h4><form onsubmit=\"if (document.getElementById('site').value) { window.location.href='" . PROXY_PREFIX . "' + document.getElementById('site').value; return false; } else { window.location.href='" . PROXY_PREFIX . $landingExampleURL . "'; return false; }\" autocomplete=\"off\"><input id=\"site\" type=\"text\" size=\"50\" /><input type=\"submit\" value=\"_stroke!\" /></form><p>~I hear and I forget, I see and I remember, I do and I understand.~</p></body></html>");
    } else {
      $url = $startURL;
    }
